...
app.layout = html.Div([
    ...
    ], className='log-container card'),
    html.Div([
        html.H3("Fiyatlar ve Kasa"),
        html.Div(id='bot-summary')
    ], className='summary-container card'),
    html.Div([
    ...
    ], className='selection-container card'),
    html.Div([
        html.Div([
    ...
    ], className='stats-trades-container card'),
